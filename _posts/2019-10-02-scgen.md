...
\sum _ {i=1} ^ n\frac{1}{{\sigma _ i} ^ 2}\int\exp\left(-\frac{z _ 1 ^ 2}{2\sigma _ 1 ^ 2}\right)\,dz _ 1\times\dots\times\int
z _ i ^ 2\exp\left(-\frac{z _ i ^ 2}{2\sigma _ i ^ 2}\right)\,dz _ i\times\dots\times\int\exp\left(-\frac{z _ n ^ 2}{2\sigma _ n ^ 2}\right)\,dz _ n\\
