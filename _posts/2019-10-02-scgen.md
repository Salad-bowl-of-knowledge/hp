...
\sum _ {i=1} ^ n\frac{1}{{\sigma _ i} ^ 2}\int\exp\left(-\frac{z _ 1 ^ 2}{2\sigma _ 1 ^ 2}\right)\,dz _ 1\times\cdots\times\int
z _ i ^ 2\exp\left(-\frac{z _ i ^ 2}{2\sigma _ i ^ 2}\right)\,dz _ i\times\cdots\times\int\exp\left(-\frac{z _ n ^ 2}{2\sigma _ n ^ 2}\right)\,dz _ n\\
&=\sum _ {i=1} ^ n\frac{1}{{\sigma _ i} ^ 2}(2\pi) ^ {\frac{n-1}{2}}\prod _ {j\neq i}\sigma _ j\sqrt{2\pi}\sigma _ i ^ 3\\ &=\sum _ {i=1} ^ n (2\pi) ^ {\frac{n}{2}}\prod _ {j=1} ^ n\sigma _ j
\end{align}
$$
